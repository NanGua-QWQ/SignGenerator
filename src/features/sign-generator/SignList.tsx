    ...
    <aside className="h-full overflow-y-auto border-r bg-background max-md:max-h-32 max-md:border-b max-md:border-r-0">
      <div className="p-3 max-md:py-2">
        <div className="mb-3 flex items-center justify-between">
          <h2 className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">编号牌列表</h2>
          <button onClick={onAdd} className="flex size-6 items-center justify-center rounded-md text-muted-foreground hover:bg-accent" title="新增编号牌"><Plus className="size-3.5" /></button>
        </div>

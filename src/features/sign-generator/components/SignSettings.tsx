              ...
              <div className="space-y-1.5">
                ...
                <div className="grid grid-cols-2 gap-1 rounded-md bg-muted p-1">
                  <Button
                    ...
                    onClick={() => onChange({ kind: 'national' })}
                  >
                    国家高速
                  </Button>
                  <Button
                    ...
                    className="h-8 rounded-sm"
                    onClick={() =>
                      onChange({ kind: 'provincial', provinceLabel: sign.provinceLabel || '粤' })
                    }
                  >
                    省高速
                  </Button>
                  <Button
                    ...
                    onClick={() => onChange({ kind: 'beijing-tianjin-hebei', provinceLabel: '' })}
                  >
                    京津冀高速
                  </Button>
                </div>
                    ...
                    {sign.digits.length === 3 && (
                      <label className="flex items-center gap-1.5 text-xs text-muted-foreground">
                        <input
                          ...
                          onChange={event => onChange({ threeDigitDescend: event.target.checked })}
                          className="size-3.5 accent-primary"
                        />
                        下沉
                      </label>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1.5">
                  ...
                  <DirectionSelect
                    ...
                    onValueChange={value => onChange({ leftDirection: value })}
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <DirectionSelect
                    ...
                    onValueChange={value => onChange({ rightDirection: value })}
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                {sign.entranceSecondDirectionEnabled ? (
                  ...
                  <DirectionSelect
                    ...
                    onValueChange={value => onChange({ entranceCardinalDirection: value })}
                  />
                )}
              </div>
              <div className="space-y-1.5">
                ...
                <div className="grid grid-cols-3 gap-1 rounded-md bg-muted p-1">
                  {ENTRANCE_ARROW_DIRECTION_OPTIONS.map(option => (
                    <Button
                      ...
                      className="h-8 rounded-sm"
                      onClick={() => onChange({ entranceArrowDirection: option.value })}
                    >
                      {option.label}
                    </Button>
                  ))}
